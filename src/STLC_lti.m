classdef STLC_lti < handle
    ...
    methods
        ...
        function Sys = STLC_lti(varargin)
           ...
           %               'cachesolvers',1);
           Sys.solver_options = sdpsettings('verbose', verb,'solver', solver,'gurobi.TimeLimit', timeLimit);
           Sys.solver_options.gurobi.MIPGap = gapLimit;
           Sys.solver_options.gurobi.MIPGapAbs = gapAbsLimit;
           Sys.solver_options.gurobi.SolutionLimit = solnLimit;
           Sys.solver_options.cachesolvers = 1;
